...
function Monthly_calories_Consumed(){
    ...
    React.useEffect(() => {
        ...
        async function fetchData() {
            try {
                // await delay(1000);
                const baseURL = "http://localhost:5000/mysql/getCaloriesConsumedgraph_Monthly/" + curruser.email;
...
export default Monthly_calories_Consumed;